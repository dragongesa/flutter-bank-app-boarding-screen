          ...
          child: Column(
            children: [
              ...
              Obx(
                ()=>Material(
                    color:
                        (controller.data.length == controller.activeIndex.value + 1)
                            ? Colors.blue
                            : Colors.white,
                    ...
                    child: InkWell(
                      ...
                      child: AnimatedContainer(
                        ...
                        width: (controller.data.length == controller.activeIndex.value + 1)
                            ? 120
                            : 80,
...
showDialog(context: context,builder: (context) {
  return AlertDialog(content: Text("It works!"),);
},);
                                      }else{
                                        controller.activeIndex.value+=1;
controller.pageController.animateToPage(controller.activeIndex.value, duration: Duration(milliseconds: 200), curve:Curves.fastOutSlowIn);
                                      }
                      },
                    ),
                  )
